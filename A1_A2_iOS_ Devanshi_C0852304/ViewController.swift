    ...
    @objc func dropPin(sender: UITapGestureRecognizer) {
        ...
        if(triangleAnnotations.count == 0){
            ...
            if(isCloseToPoint(p1: CLLocation(latitude: coordinate.latitude, longitude: coordinate.longitude), p2: CLLocation(
                ...
                mapView.removeAnnotation(triangleAnnotations[0])
                ...
                mapView.removeAnnotation(triangleAnnotations[1])
                ...
                reDrawAnnotations()
                    ...
                    mapView.removeAnnotation(triangleAnnotations[2])
